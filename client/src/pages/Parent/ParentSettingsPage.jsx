...
const handleSaveProfile = () => {
  // API call (future)
  console.log("Saving profile:", parentProfile);
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-3 mt-3">
                      <button
                        ...
                        className="px-4 py-2 bg-[#009846] text-white rounded-lg shadow-sm hover:bg-[#0e3a29]"
                      >
                      Save Changes
                      </button>
  ...
  className="px-3 py-2 border border-[#E6F4EC] rounded-md text-[#124734] bg-white hover:bg-[#F3FFF7]"
>
  Reset
</button>
                ...
                <div className="bg-white rounded-2xl border border-[#E6F4EC] shadow-md p-6">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-[#009846] text-white rounded-md shadow-sm hover:bg-[#008a3a]"
                    >
                      + Add New Child
                    </button>
                  </div>
