      ...
      <div className="max-w-4xl mx-auto px-6 md:px-8 py-16 text-left">
        <div className="bg-[#A7E1B2] rounded-2xl shadow-lg p-6 md:p-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-8">
            <button onClick={shareOnWhatsApp} className="flex items-center gap-2 bg-[#25D366] text-white px-4 py-2 rounded-full">
              <img src={whatsappIcon} className="w-5 h-5" />
              Share on WhatsApp
            </button>

            <button onClick={shareOnLinkedIn} className="flex items-center gap-2 bg-[#0A66C2] text-white px-4 py-2 rounded-full">
