...
const JobDetail = () => {
  ...
  if (!job)
    return <h2 className="text-center mt-10 text-red-600">Job not found</h2>;

  // ---------------- Auto-extract list items (NO content change) ----------------
          ...
          <div className="bg-white w-full max-w-xl rounded-2xl shadow-xl p-6 relative max-h-[80vh] overflow-y-auto">
            ...
            <form className="space-y-4 text-left">
              ...
              <div>
                ...
                <select className="w-full p-3 border rounded-lg focus:ring-2 focus:ring-[#1E5631]">
              ...
              <button className="bg-[#1E5631] w-full text-white py-3 rounded-lg text-lg font-semibold hover:bg-[#154727] transition">
                Submit Application
              </button>
            </form>
          </div>
