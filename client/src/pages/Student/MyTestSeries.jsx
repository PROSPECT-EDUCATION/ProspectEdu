...
export default function MyTestSeries() {
  ...
  const testSeries = [];
  const filteredList = testSeries;

  // ✅ SEO: block indexing for private page
  useEffect(() => {
    ...
    <div className="flex h-screen bg-[#F9FAFB] overflow-hidden">
      ...
      >
        ...
        <nav
          ...
          aria-label="My test series navigation"
        >
        ...
        <main
          ...
          aria-labelledby="my-test-series-heading"
        >
          {/* Hidden semantic heading */}
          <h1 id="my-test-series-heading" className="sr-only">
            Student Purchased Test Series
          </h1>
