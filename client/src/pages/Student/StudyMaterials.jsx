...
export default function StudyMaterials() {
  ...
  const studyMaterials = [
    {
      title: "NCERT Biology Class 11 – Chapter 1 Notes",
      category: "Biology",
    },
    {
      title: "NCERT Chemistry Class 12 – Organic Chemistry Summary",
      category: "Chemistry",
    },
    {
      title: "Physics Wallah Handwritten Notes – Motion in a Plane",
      category: "Physics",
    },
    {
      title: "KGS Institute – Polity Complete Notes PDF",
      category: "Polity",
    },
    {
      title: "Geography Module – Indian Climate Overview",
      category: "Geography",
    },
  ];
          ...
          <div className="w-full max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {studyMaterials.map((item, index) => (
              ...
              >
                ...
                <p className="text-[#5B7065] text-sm mb-4">{item.category}</p>
