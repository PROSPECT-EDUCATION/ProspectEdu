    ...
    <div className="flex bg-[#F9FAFB] min-h-screen text-left">
      ...
      >
        ...
        <div className="p-8">
                    ...
                    >
                      <td className="px-6 py-4 flex items-center gap-3">
                        <img
                          ...
                          alt={p.name || "product"}
                        />
                        <span className="text-lg font-semibold text-[#124734]">
                          {p.name}
                        </span>
                      </td>
          ...
          {/* ================ MOBILE CARD VIEW (SAME LAYOUT) ================ */}
          <div className="md:hidden space-y-5 mt-5">
            {loading && (
              <div className="bg-white p-4 rounded-xl shadow border border-[#A7E1B2]/40">
                Loading...
              </div>
            )}
