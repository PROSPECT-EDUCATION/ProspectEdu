...
export default function Navbar() {
  ...
  const links = [
    { label: "Home" },
    { label: "Courses", dropdown: ["Information Technology", "Law", "Electrical"] },
  ...
  return (
    <header className="w-full bg-[#FFFFFF] shadow-sm sticky top-0 z-50">
      <div className="flex items-center justify-between px-8 py-3 max-w-7xl mx-auto">
        ...
        {/* Right: Login */}
        <button className="border border-[#009846] text-[#009846] rounded-full px-5 py-2 font-medium hover:bg-[#009846] hover:text-white transition-all duration-300 whitespace-nowrap">
          Login
        </button>
      </div>
    </header>
