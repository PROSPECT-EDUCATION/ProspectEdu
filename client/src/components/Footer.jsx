    ...
    <footer className="bg-[#124734] text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <nav aria-label="Popular career courses">
          ...
          <ul className="space-y-2 text-sm">
            <li><Link to="/courses/engineering" className="hover:text-[#A7E1B2]">Engineering Courses</Link></li>
            <li><Link to="/courses/law" className="hover:text-[#A7E1B2]">Law Courses</Link></li>
            <li><Link to="/courses/management" className="hover:text-[#A7E1B2]">Management Courses</Link></li>
          </ul>
        </nav>
