...
export default function EditTeacherForm({ initialData, onSubmit }) {
  ...
  const handleSubmit = (e) => {
    ...
    onSubmit(form); // Send updated data to page
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl shadow-md">
      ...
      <h2 className="text-xl font-semibold text-[#124734] mb-4">Edit Teacher</h2>
