...
import parentImg from "../../assets/ParentCompany.png";
 // you can replace with another image
  ...
  return (
    <section className="bg-[#F9FAFB] text-[#124734] py-16 font-[Open_Sans,sans-serif]">
      ...
      <div className="max-w-6xl mx-auto px-8 py-20">
        <div className="bg-[#A7E1B2] p-10 rounded-2xl shadow-xl">
          <h2 className="text-3xl font-bold text-[#124734] mb-4">
            About Services
          </h2>
          <div className="h-[4px] w-40 bg-[#124734] mb-8"></div>

          <p className="text-lg leading-8 text-[#124734]">
