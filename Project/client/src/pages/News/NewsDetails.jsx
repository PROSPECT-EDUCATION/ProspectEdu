...
`;
  ...
  return (
    <section className="bg-[#F9FAFB] text-[#124734] py-10 md:py-16 font-[Open_Sans,sans-serif]">
      ...
      {/* ---------------- Report Content ---------------- */}
      <div className="max-w-5xl mx-auto mt-10 bg-white shadow-md rounded-xl p-5 sm:p-6 md:p-8 lg:p-10 relative">

        {/* Top Right Language Toggle */}
        <div className="absolute top-3 sm:top-4 right-3 sm:right-4 flex gap-2">
          <button
            onClick={() => setLanguage("English")}
            className={`px-3 sm:px-4 py-1 rounded-md border text-xs sm:text-sm font-medium transition ${
              language === "English"
        ...
        <button
          onClick={() => navigate(-1)}
          className="text-[#1E5631] mb-5 sm:mb-6 text-sm sm:text-base font-semibold hover:underline"
        >
          ← Back
        </button>

        {/* Title */}
        <h2 className="text-2xl sm:text-3xl font-bold text-[#124734] mb-3 border-b border-gray-300 pb-2">
          {report.title}
        </h2>

        {/* Dynamic Content */}
        <div className="text-gray-800 leading-relaxed whitespace-pre-line text-sm sm:text-[15px] mt-2">
